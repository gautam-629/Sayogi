      ...
      <div>
        <div className={`bg-secBackColor shadow-lg duration-300 h-screen ${open ? "w-72" : "w-20"} p-5 pt-8 relative`}>
          ...
          <ul className='mt-3 gap-y-2'>
            ...
            <li className='flex gap-x-3 items-center pt-3'>
              <img src={'/img/serviceRequest.png'} height={10} width={25} alt='create porfile' />
              <Link to={'/servicerequest'}> <span className={`text-textColor ${!open && 'hidden'} cursor-pointer hover:border-b-4 border-blue text-xl font-bold`}>Service Request</span></Link>
            </li>
            ...
            <li className='flex gap-x-3 items-center pt-3'>
              <img src={'/img/history.png'} height={10} width={25} alt='create porfile' />
              <span className={`text-textColor ${!open && 'hidden'} cursor-pointer hover:border-b-4 border-blue text-xl font-bold`}>History</span>
              {open &&
                <img className={`${subMenuOpen && "rotate-180 duration-200"}`} onClick={(e) => { setSubMenuOpen(!subMenuOpen) }} src={'/img/downarrow.png'} height={10} width={25} alt='downarrow' />
              }
            </li>
