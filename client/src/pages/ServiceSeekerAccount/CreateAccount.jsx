...
const CreateAccount = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Validate Experience
    if (experience.length < 3 || experience.length > 30) {
      errorNotify("Experience must be between 3 and 30 characters.");
      return;
    }
    ...
    // Validate Skills
    if (skills.length < 3 || skills.length > 30) {
      errorNotify("Skills must be between 3 and 30 characters.");
      return;
    }
