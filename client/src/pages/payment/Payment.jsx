    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if (result.paymentIntent.status === 'succeeded') {
                ...
                let paymentRes;
                try {
                    let paymentRes= await axios.post('http://localhost:5000/api/v1/paymentinfo',{paymentInfo,serviceId})
                } catch (error) {
                    console.log(error)
                }
                    ...
                    <div className="row wrapper">
                        <div className="col-10 col-lg-5 mx-auto">
                            <form className="shadow-lg p-4" onSubmit={handleSubmit}>
                                <h1 className="mb-4 text-center text-3xl text-textColor">Card Info</h1>
                                <div className="form-group">
                                    <label htmlFor="card_num_field" className="text-sm font-medium text-textColor">
                                        Card Number
                                    </label>
                                    <CardNumberElement
                                        type="text"
                                ...
                                <div className="form-group mt-4">
                                    <label htmlFor="card_exp_field" className="text-sm font-medium text-textColor">
                                        Card Expiry
                                    </label>
                                    <CardExpiryElement
                                        type="text"
                                ...
                                <div className="form-group mt-4">
                                    <label htmlFor="card_cvc_field" className="text-sm font-medium text-textColor">
                                        Card CVC
                                    </label>
                                    <CardCvcElement
                                        type="text"
